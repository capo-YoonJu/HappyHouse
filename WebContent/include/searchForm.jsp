...
<form class="form-search col-md-12" name="choice" style="margin-top: -100px;" method="get" action="${root}/house/searchData.do">
	<div class="row  align-items-end">
			...
			<div class="col-md-2">
			<input type="button" onclick="check()" class="btn btn-success text-white btn-block rounded-0" value="검색">
		</div>
	</div>
</form>